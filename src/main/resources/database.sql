...
ALTER TABLE  owners ADD COLUMN had_account BOOLEAN default 0;
ALTER TABLE  owners drop COLUMN hadAccount ;
-- ================================================================
-- TABLE: pets
-- ================================================================
CREATE TABLE pets (
...
ALTER TABLE boarding_records ALTER COLUMN total_fee SET DEFAULT 0;
ALTER TABLE boarding_records ADD COLUMN expected_check_out DATETIME NOT NULL DEFAULT (CURRENT_TIMESTAMP + INTERVAL 1 DAY);
-- ================================================================
-- TABLE: care_notes
-- ================================================================
...
insert into users(username,password,owner_id, role) values(
			"1213123123132",
			"123456765",
			1,
			"ROLE_CUSTOMER"
...
CREATE TABLE admin_setting (
    ...
    base_fee double default 50000,
    late_free_per_hour double default 20000,
    update_by bigint,
    updated_at datetime,
    constraint fk_admin FOREIGN key (update_by) references users(id)
);
ALTER TABLE admin_setting RENAME COLUMN base_fee TO price_per_day;
ALTER TABLE admin_setting 
MODIFY COLUMN updated_at DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE admin_setting ADD COLUMN penaltyPercentage DECIMAL(1,1) DEFAULT 0.2;
INSERT INTO admin_setting (base_fee, late_free_per_hour, update_by) 
VALUES (50000, 20000, 1);
